 ...
 */
 /* Mods
  6dec16 - zig add widget area at bottom of archive
*/
	...
	<div id="left-content">
		...
		<div id="content-container">
			...
			<div id="content">
					...
					<div class="box">
						<div class="intern-padding">
							...
							<div class="center" id="blog-bottom">
								...
								<?php $new_blog_button_text = apply_filters('woffice_new_blog_article_button_text', __("New Blog Article", "woffice")); ?>
				...
				<?php endif; ?>
				<?php /* zig */
				if (is_active_sidebar('blog-bottom-extra')) {
					echo '<div class="box">';
						echo '<div id="blog-bottom-extra">';
							dynamic_sidebar('blog-bottom-extra');
						echo '</div>';
					echo '</div>';
				}
 			?>
